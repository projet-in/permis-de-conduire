...
const CATALOGUE_A = {
  ...
  A1c:{nom:"Succession de virages, premier à gauche", svg:triangleDanger(`<path d="M30,66 Q30,40 50,40 Q70,40 70,60" fill="none" stroke="var(--encre)" stroke-width="5"/>`)},
  A1d:{nom:"Succession de virages, premier à droite", svg:triangleDanger(`<path d="M70,66 Q70,40 50,40 Q30,40 30,60" fill="none" stroke="var(--encre)" stroke-width="5"/>`)},
  ...
  A5:{nom:"Chaussée rétrécie", svg:triangleDanger(`<path d="M25,42 L45,58 L25,74 M75,42 L55,58 L75,74" fill="none" stroke="var(--encre)" stroke-width="4"/>`)},
  A7a:{nom:"Chaussée rétrécie par la droite", svg:triangleDanger(`<path d="M75,42 L50,58 L75,74" fill="none" stroke="var(--encre)" stroke-width="4"/><line x1="25" y1="70" x2="75" y2="70" stroke="var(--encre)" stroke-width="3"/>`)},
  A7b:{nom:"Chaussée rétrécie par la gauche", svg:triangleDanger(`<path d="M25,42 L50,58 L25,74" fill="none" stroke="var(--encre)" stroke-width="4"/><line x1="25" y1="70" x2="75" y2="70" stroke="var(--encre)" stroke-width="3"/>`)},
  A7c:{nom:"Chaussée rétrécie (variante)", svg:triangleDanger(`<path d="M25,42 L45,58 L25,74 M75,42 L55,58 L75,74" fill="none" stroke="var(--encre)" stroke-width="3"/>`)},
  ...
  A11:{nom:"Débouché sur une berge/un quai", svg:triangleDanger(`<line x1="22" y1="68" x2="78" y2="68" stroke="var(--encre)" stroke-width="4"/><path d="M22,68 Q35,74 48,68 Q61,62 78,68" fill="none" stroke="var(--encre)" stroke-width="3"/>${pVoiture(50,52,0.55)}`)},
  ...
  A14:{nom:"Chaussée glissante", svg:triangleDanger(`<polyline points="25,60 40,45 50,60 60,45 75,60" fill="none" stroke="var(--encre)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>`)},
  A15:{nom:"Projection de gravillons", svg:triangleDanger(`<circle cx="42" cy="52" r="3" fill="var(--encre)"/><circle cx="55" cy="48" r="3" fill="var(--encre)"/><circle cx="60" cy="62" r="3" fill="var(--encre)"/><circle cx="46" cy="66" r="3" fill="var(--encre)"/>${pVoiture(50,45,0.4)}`)},
  A17:{nom:"Chute de pierres", svg:triangleDanger(`<polygon points="35,45 45,55 38,66 28,58" fill="var(--encre)"/><polygon points="55,50 66,58 58,68 48,62" fill="var(--encre)"/>`)},
  A19:{nom:"Passage pour piétons", svg:triangleDanger(pPieton(50,55,0.85))},
  A21:{nom:"Enfants", svg:triangleDanger(`${pPieton(40,58,0.55)}${pPieton(60,58,0.65)}`)},
  A23:{nom:"Cyclistes débouchant", svg:triangleDanger(pVelo(50,58,0.85))},
  A25:{nom:"Passage pour cyclistes", svg:triangleDanger(pVelo(50,58,0.85))},
  A27:{nom:"Passage à niveau avec barrières", svg:triangleDanger(`<line x1="25" y1="68" x2="75" y2="45" stroke="var(--encre)" stroke-width="5"/><line x1="30" y1="60" x2="38" y2="70" stroke="var(--encre)" stroke-width="4"/><line x1="55" y1="50" x2="63" y2="60" stroke="var(--encre)" stroke-width="4"/>`)},
  A29:{nom:"Passage à niveau sans barrières", svg:triangleDanger(pTrain(50,55,0.7))},
  A31:{nom:"Circulation dans les deux sens", svg:triangleDanger(pFleche(35,50,35,68)+pFleche(65,68,65,50))},
  A33:{nom:"Feux tricolores", svg:triangleDanger(`<rect x="42" y="42" width="16" height="34" rx="4" fill="var(--encre)"/><circle cx="50" cy="50" r="4" fill="var(--rouge)"/><circle cx="50" cy="59" r="4" fill="var(--jaune)"/><circle cx="50" cy="68" r="4" fill="var(--vert)"/>`)},
  A35:{nom:"Chute de pierres ou éboulement", svg:triangleDanger(`<path d="M25,68 L45,45 L58,60 L75,68" fill="none" stroke="var(--encre)" stroke-width="4"/><polygon points="40,50 46,56 40,62 34,56" fill="var(--encre)"/>`)},
  A37:{nom:"Chaussée déformée", svg:triangleDanger(`<path d="M22,66 Q35,55 45,66 Q55,77 65,66 Q72,58 78,66" fill="none" stroke="var(--encre)" stroke-width="4"/>`)},
  A39:{nom:"Circulation intense de gibier", svg:triangleDanger(`<path d="M42,68 L42,52 L34,58 M42,52 L50,44 L58,52 M58,52 L66,58" fill="none" stroke="var(--encre)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>`)},
  A41:{nom:"Vent latéral", svg:triangleDanger(`<path d="M25,50 Q45,44 55,52 Q65,60 75,54" fill="none" stroke="var(--encre)" stroke-width="4"/><path d="M25,64 Q45,58 55,66" fill="none" stroke="var(--encre)" stroke-width="4"/>`)},
  A43:{nom:"Circulation en sens inverse", svg:triangleDanger(pFleche(35,68,65,68)+pFleche(65,50,35,50))},
  A45:{nom:"Ralentisseur de type dos d'âne", svg:triangleDanger(`<path d="M22,66 Q50,44 78,66" fill="none" stroke="var(--encre)" stroke-width="4"/>`)},
  A47:{nom:"Risque de verglas", svg:triangleDanger(`<line x1="50" y1="42" x2="50" y2="72" stroke="var(--encre)" stroke-width="3"/><line x1="38" y1="48" x2="62" y2="66" stroke="var(--encre)" stroke-width="3"/><line x1="62" y1="48" x2="38" y2="66" stroke="var(--encre)" stroke-width="3"/>`)},
  A49:{nom:"Circulation d'engins agricoles", svg:triangleDanger(`<rect x="32" y="52" width="20" height="14" rx="2" fill="var(--encre)"/><circle cx="38" cy="70" r="7" fill="none" stroke="var(--encre)" stroke-width="3"/><circle cx="58" cy="70" r="5" fill="none" stroke="var(--encre)" stroke-width="3"/>`)},
  A50:{nom:"Aéronefs volant à basse altitude", svg:triangleDanger(`<path d="M30,58 L70,58 M50,48 L50,68 M40,64 L60,64" stroke="var(--encre)" stroke-width="4" fill="none"/>`)},
  A51:{nom:"Danger non déterminé", svg:triangleDanger(pExclamation(50,58))},
};

// --- Famille B : signaux de priorité ---
const CATALOGUE_B = {
  B1:{nom:"Cédez le passage", svg:triangleCeder("")},
  B3:{nom:"Cédez le passage au carrefour giratoire", svg:triangleCeder(`<circle cx="50" cy="60" r="10" fill="none" stroke="var(--encre)" stroke-width="4"/>`)},
  B5:{nom:"Arrêt (STOP)", svg:PANNEAUX.B5},
  B7:{nom:"Arrêt au poste de douane/péage", svg:svgWrap(`<polygon points="30,4 70,4 96,30 96,70 70,96 30,96 4,70 4,30" fill="var(--rouge)" stroke="#fff" stroke-width="4"/><text x="50" y="62" text-anchor="middle" font-size="22" font-weight="800" fill="#fff" font-family="Arial">STOP</text>`)},
  B9:{nom:"Voie prioritaire", svg:losange("")},
  B11:{nom:"Fin de voie prioritaire", svg:losange("", true)},
  B13:{nom:"Annonce d'une intersection où l'on a priorité", svg:triangleDanger(`<rect x="40" y="42" width="20" height="20" rx="5" fill="var(--jaune)" stroke="#C89A00" stroke-width="3" transform="rotate(45 50 52)"/>`)},
  B15:{nom:"Priorité au prochain carrefour", svg:PANNEAUX.B15},
  B17:{nom:"Annonce d'un signal B1 ou B5", svg:triangleDanger(`<polygon points="50,64 66,52 34,52" fill="none" stroke="var(--rouge)" stroke-width="4"/>`)},
  B19:{nom:"Cédez le passage au croisement étroit", svg:PANNEAUX.B19},
  B21:{nom:"Priorité au croisement étroit", svg:PANNEAUX.B21},
  B22:{nom:"Priorité aux véhicules venant en sens inverse", svg:svgWrap(`<circle cx="50" cy="50" r="46" fill="var(--bleu)"/><line x1="50" y1="75" x2="50" y2="35" stroke="#fff" stroke-width="7"/><polygon points="50,25 60,42 40,42" fill="#fff"/><polygon points="50,75 40,58 60,58" fill="var(--rouge)"/>`)},
  B23:{nom:"Cédez le passage aux véhicules venant en sens inverse", svg:svgWrap(`<circle cx="50" cy="50" r="44" fill="#fff" stroke="var(--rouge)" stroke-width="7"/><line x1="50" y1="75" x2="50" y2="35" stroke="var(--rouge)" stroke-width="7"/><polygon points="50,25 60,42 40,42" fill="var(--rouge)"/>`)},
};
